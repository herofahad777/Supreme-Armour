...
public class SwatAdvancementProcedureProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SupremeArmourMod.LOGGER.warn("Failed to load dependency entity for procedure SwatAdvancementProcedure!");
			return;
		}
		Entity entity = (Entity) dependencies.get("entity");
		if (SwatItem.boots == ((entity instanceof LivingEntity)
				? ((LivingEntity) entity).getItemStackFromSlot(EquipmentSlotType.FEET)
				: ItemStack.EMPTY).getItem()) {
			if (SwatItem.legs == ((entity instanceof LivingEntity)
				...
				if (SwatItem.helmet == ((entity instanceof LivingEntity)
					...
					if (entity instanceof ServerPlayerEntity) {
						Advancement _adv = ((MinecraftServer) ((ServerPlayerEntity) entity).server).getAdvancementManager()
								.getAdvancement(new ResourceLocation("supreme_armour:prepare_to_fight"));
